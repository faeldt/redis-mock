 ...
 * Append
 */
exports.append = function(mockInstance, key, value, callback) {
    if (mockInstance.storage[key]) {
       var newstr = mockInstance.storage[key].value + value;
       exports.set(mockInstance, key, newstr);
       mockInstance._callCallback(callback, null, newstr);
    } else {
      exports.set(mockInstance, key, value, callback);
    }
}
