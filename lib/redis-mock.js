...
RedisClient.prototype.rpoplpush = RedisClient.prototype.RPOPLPUSH = function(fromKey, toKey, callback) {
    listfunctions.rpoplpush.call(this, MockInstance, fromKey, toKey, callback);
};
...
RedisClient.prototype.ping = function(callback) {
    serverfunctions.ping.call(this, MockInstance, callback);
};

RedisClient.prototype.dbsize = function(callback) {
    serverfunctions.dbsize.call(this, MockInstance, callback);
};

RedisClient.prototype.save = function(callback) {
    serverfunctions.save.call(this, MockInstance, callback);
};

RedisClient.prototype.lastsave = function(callback) {
    serverfunctions.lastsave.call(this, MockInstance, callback);
};

RedisClient.prototype.time = function(callback) {
    serverfunctions.time.call(this, MockInstance, callback);
};
