...
RedisClient.prototype.lpush = RedisClient.prototype.LPUSH = function(key, value, callback) {
  listfunctions.lpush.call(this, MockInstance, key, value, callback);
}

RedisClient.prototype.rpush = RedisClient.prototype.RPUSH = function(key, value, callback) {
  listfunctions.rpush.call(this, MockInstance, key, value, callback);
}
