...
/**
 * Helper function for varargs. Handles getting a callback function.
 */
...
RedisClient.prototype.hmget = RedisClient.prototype.HMGET = function(hash) {
  var args = getVarargs(arguments);
  if (args.members.length === 1 && args.members[0] instanceof Array) {
    args.members = args.members[0];
  }
  hashing.hmget.call(this, MockInstance, hash, args.members, args.callback);
}
 ...
 */
var zsetfunctions = require("./sortedset.js");

RedisClient.prototype.zadd = RedisClient.prototype.ZADD = function(key, member, callback) {
  var args = getVarargs(arguments);
  zsetfunctions.zadd.call(this, MockInstance, key, args.members, args.callback);
}

RedisClient.prototype.zrem = RedisClient.prototype.ZREM = function(key, member, callback) {
  var args = getVarargs(arguments);
  zsetfunctions.zrem.call(this, MockInstance, key, args.members, args.callback);
}

RedisClient.prototype.zcard = RedisClient.prototype.ZCARD = function(key, callback) {
  zsetfunctions.zcard.call(this, MockInstance, key, callback);
}

RedisClient.prototype.zrange = RedisClient.prototype.ZRANGE = function(key, start, stop, callback) {
  zsetfunctions.zrange.call(this, MockInstance, key, start, stop, callback);
}

RedisClient.prototype.zrevrange = RedisClient.prototype.ZREVRANGE = function(key, start, stop, callback) {
  zsetfunctions.zrevrange.call(this, MockInstance, key, start, stop, callback);
}

RedisClient.prototype.zrank = RedisClient.prototype.ZRANK = function(key, member, callback) {
  zsetfunctions.zrank.call(this, MockInstance, key, member, callback);
}

RedisClient.prototype.zrevrank = RedisClient.prototype.ZREVRANK = function(key, member, callback) {
  zsetfunctions.zrevrank.call(this, MockInstance, key, member, callback);
}
