...
RedisClient.prototype.lrange = RedisClient.prototype.lrange = function(key, start, stop, callback) {
  listfunctions.lrange.call(this, MockInstance, key, start, stop, callback);
};
