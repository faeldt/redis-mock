...
RedisClient.prototype.blpop = RedisClient.prototype.BLPOP = function(key, callback) {
  listfunctions.blpop.call(this, MockInstance, key, callback);
}

RedisClient.prototype.brpop = RedisClient.prototype.BRPOP = function(key, callback) {
  listfunctions.brpop.call(this, MockInstance, key, callback);
}
