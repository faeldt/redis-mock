...
var CMD_FACTORY = {
  ...
  string: {
    ...
    commands: [ 'get', 'set', 'incr', 'setex' ]
  },
  hash: {
    lib: require('./hash.js'),
    commands: [ 'hget', 'hexists', 'hdel', 'hset', 'hincrby', 'hsetnx', 'hlen', 'hkeys', 'hgetall', 'hmset' ]
  },
  list: {
    lib: require('./list.js'),
    commands: [ 'llen', 'lpush', 'rpush', 'lpushx', 'rpushx', 'lpop', 'rpop', 'brpop', 'blpop', 'lindex', 'lset' ]
  },
  set: {
    lib: require('./set.js'),
